...
def backbone_meta(backbone):
    ...
    if 'resnet' in backbone:
        from .resnet import ResNetMeta as meta
    elif 'mobilenet' in backbone:
        from .mobilenet import MobileNetMeta as meta
    elif 'vgg' in backbone:
        from .vgg import VGGMeta as meta
    elif 'densenet' in backbone:
        from .densenet import DenseNetMeta as meta
    else:
